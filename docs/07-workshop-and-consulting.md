...
- 你照 README 做但卡在 skill 不觸發、`SKILL.md` frontmatter 或抽取腳本的問題。
- 你想把範例改成公司內部流程（巡檢日報、客服摘要、採購簽核、工單整理等）。
- 你需要幫客戶或老闆做一個能展示的 PoC。
- 你想知道這個 starter 上線前還缺哪些設計（多 skill 協作、版本管理、測試）。
- 你想用這個題目規劃內訓或小班課程。
...
- 公司 PoC 需求訪談與架構建議。
- 協助把 skill 整進公司既有的 AI 工作流程。

## 聯絡方式

- GitHub Pages：https://yazelin.github.io/agent-skill-starter/
- GitHub repo：https://github.com/yazelin/agent-skill-starter
...
> 把一套做法打包成可重用、會自動觸發、精確的部分交給腳本——這條線，我們做成了 AgentOS（agent 治理）與 Mori Desktop（個人 AI 管家）。
